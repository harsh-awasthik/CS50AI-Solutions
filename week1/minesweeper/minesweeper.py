...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for a in [i-1, i, i+1]:
            for b in [j-1, j, j+1]:
                c = (a, b)
                if a > -1 and b > -1 and a < self.height and b < self.width:
    ...
    def make_random_move(self):
        ...
        randCell = (random.randrange(0, self.height), random.randrange(0, self.width))
        while randCell in self.moves_made or randCell in self.mines:
            randCell = (random.randrange(0, self.height), random.randrange(0, self.width))
        return randCell
